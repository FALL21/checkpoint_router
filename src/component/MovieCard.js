...
function MovieCard() {
    ...
    return (
        <>
            <input type="text" id="nameFiltred" placeholder="Name filtred" onChange={e => { setTitleSearch(e.target.value) }} style={{marginLeft:"40%", marginTop:"5%"}}/><br /><br />
            <input type="number" id="rateFiltred" max="5" min="0" placeholder="Rate filtred" onChange={e => { setRateSearch(e.target.value) }} style={{marginLeft:"40%",width:"10%"}} /><br /><br />
            <div className="gridMovie">
                <div className="movieCard">
                    {(titleSearch && rateSearch === "") ?
                        (moviesFiltredTitle.map((movie) => {
                            return (
                                <div className="card" style={{ width: '16em' }} key={movie.id}>
